...
export async function getCommandDocs(commandName, docs) {
    try {
...
export async function searchCommands(query, limit = 10) {
    try {
...
async function checkGlobalPackage(packageName, filePath) {
