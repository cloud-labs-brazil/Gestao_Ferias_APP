...
export class AuditLogger {
    ...
    logToConsole(entry) {
        ...
        console.error(`[AUDIT] ${prefix} ${entry.operationType} ${entry.componentType}${dryRunLabel} - ${status}${timeLabel}`);
    ...
    getFilteredLogs(filter) {
        return this.logs.filter(entry => {
            ...
            if (filter.success !== undefined && entry.success !== filter.success)
                return false;
            if (filter.solutionName && entry.solutionName !== filter.solutionName)
                return false;
 ...
 */
export async function auditOperation(params, fn) {
